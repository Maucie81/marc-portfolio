  ...
  return (
    ...
    >
      <div className="flex shrink-0 items-center gap-3 border-b border-line/70 px-4 py-3">
        ...
        <span className="text-sm font-bold leading-none text-[#FF5A5F]">
          airbnb<span className="font-normal"> hotels</span>
        </span>
        <div className="ml-auto flex items-center gap-3">
          ...
          <span className="flex h-6 w-6 items-center justify-center rounded-full border border-[#FF5A5F] text-[10px] font-semibold leading-none text-[#FF5A5F]">
            HM
          </span>
        </div>
      </div>
